...
impl Request {
    ...
    /// Replaces the header value with the given key if it exists, or inserts it if it doesn't.
    pub fn replace_header<T: Into<String>, U: Into<String>>(mut self, key: T, value: U) -> Request {
        let key = key.into();
